...
<body>
	...
	<ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
				...
				<li ${uri == 'companyListing' ? 'class="active"' : '' }><a href="createDesignation"><i class="icon-chevron-right"></i>
				Manage Designation</a></li>
				<li ${uri == 'companyListing' ? 'class="active"' : '' }><a href="createDepartment"><i class="icon-chevron-right"></i>
